...
<%
User ifo=(User)request.getAttribute("U_id");
%>
<div id="menu" class="searchpage">
<h1 style="margin-bottom:0;">Change User Information</h1>
<form action="Search?pageT=Change&pageN=Change" class="searchbar" method="post" >
Name: <%=ifo.getName() %><br><br>
Password:<br>
<input type="password" name="psw" value=<%=ifo.getPsw() %>>
<br>
Email:<br>
<input type="email" name="email" value=<%=ifo.getEmail() %>>
<br>
Nick Name:<br>
<input type="text" name="nick" value=<%=ifo.getNick() %>>
<br>
First Name:<br>
<input type="text" name="first" value=<%=ifo.getFirst() %>>
<br>
Last Name:<br>
<input type="text" name="last" value=<%=ifo.getLast() %>>
<br>
Birth:<br>
<input type="date" name="birth" value=<%=ifo.getBirth() %>>
<br>
Card:<br>
<input type="text" name="card" value=<%=ifo.getCard() %>>
<br>
Address:<br>
<input type="text" name="addr" value=<%=ifo.getAddr() %>>
<br>
