...
<h1 style="margin-bottom:0;">Upload a book</h1>
<form action="Search?pageT=Addbook&pageN=Add" class="searchbar" method="post" enctype="multipart/form-data" >
Title:<br>
